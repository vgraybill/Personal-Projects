...
$('article').on('mouseenter', function(){
    ...
    current.find('h4').stop().transit({'opacity':'100%'},300);
    current.find('h4').parent().stop().transit({'border':'2px solid aliceblue'},300);
});
$('article').on('mouseleave', function(){
    current=$(this);
    current.stop().transit({'background-size':'100%'}, 300);
    current.find('.overlay').stop().transit({'background':'transparent'}, 200)
    current.find('h4').stop().transit({'opacity':'0'},300);
    current.find('h4').parent().stop().transit({'border':'2px solid rgba(240, 248, 255, 0.445)'},300);
});